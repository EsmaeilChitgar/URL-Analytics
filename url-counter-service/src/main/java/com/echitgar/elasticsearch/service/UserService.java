package com.echitgar.elasticsearch.service;

import co.elastic.clients.elasticsearch._types.query_dsl.Operator;
import co.elastic.clients.elasticsearch._types.query_dsl.Query;
import com.echitgar.common.model.User;
import com.echitgar.elasticsearch.repository.UserRepository;
...
public class UserService {
  ...
  public List<User> search(String keywords) {
    Float nonExistingBoost =
        null; // even though it exists in SpringBoot, ElasticSearch has no boost for this type of
    // query
    // when you analyze what matchQuery returns, it also has nothing related to boost
    Query query =
        QueryBuilders.matchQuery("country", keywords, Operator.Or, nonExistingBoost)._toQuery();
